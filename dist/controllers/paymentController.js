...
var initiateUPIPayment = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var timeNow, type, auth, money, minimumMoneyAllowed, _ekqrData$data, _ekqrData$data$upi_in, _ekqrData$data2, _ekqrData$data2$upi_i, _ekqrData$data3, _ekqrData$data3$upi_i, _ekqrData$data4, _ekqrData$data4$upi_i, _user3, pendingRechargeList, deleteRechargeQueries, orderId, ekqrResponse, ekqrData, newRecharge, recharge;
        ...
        case 28:
          ...
          return _context5.abrupt("return", res.status(200).json({
            ...
            urls: {
              ...
              bhim_link: ((_ekqrData$data = ekqrData.data) === null || _ekqrData$data === void 0 ? void 0 : (_ekqrData$data$upi_in = _ekqrData$data.upi_intent) === null || _ekqrData$data$upi_in === void 0 ? void 0 : _ekqrData$data$upi_in.bhim_link) || "",
              phonepe_link: ((_ekqrData$data2 = ekqrData.data) === null || _ekqrData$data2 === void 0 ? void 0 : (_ekqrData$data2$upi_i = _ekqrData$data2.upi_intent) === null || _ekqrData$data2$upi_i === void 0 ? void 0 : _ekqrData$data2$upi_i.phonepe_link) || "",
              paytm_link: ((_ekqrData$data3 = ekqrData.data) === null || _ekqrData$data3 === void 0 ? void 0 : (_ekqrData$data3$upi_i = _ekqrData$data3.upi_intent) === null || _ekqrData$data3$upi_i === void 0 ? void 0 : _ekqrData$data3$upi_i.paytm_link) || "",
              gpay_link: ((_ekqrData$data4 = ekqrData.data) === null || _ekqrData$data4 === void 0 ? void 0 : (_ekqrData$data4$upi_i = _ekqrData$data4.upi_intent) === null || _ekqrData$data4$upi_i === void 0 ? void 0 : _ekqrData$data4$upi_i.gpay_link) || ""
            },
            status: true,
            timeStamp: timeNow
          }));
