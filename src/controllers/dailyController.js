...
// const trxwingo = async (req, res) => {
//     try {
//         // Fetch data from trx table using the shared connection
//         const [trxgetData] = await connection.execute('SELECT * FROM trx WHERE type = 1 ORDER BY id DESC');

//         // Log the fetched data for debugging
//         console.log("result data as....", trxgetData);
//         res.status(200).json({ trxdata: trxgetData });

//     } catch (error) {
//         console.error('Error fetching trx data:', error);
//         res.status(500).json({ error: 'Error fetching trx data' });
//     }
// }
...
const trxwingo = async (req, res) => {
    try {
        ...
        console.log("result data as....", trxgetData)
        // res.render('../views/bet/wingo/trx.ejs', { trxdata: trxgetData });
        // res.render('../views/bet/wingo/trx.ejs', { trxdata: trxgetData });
        // return res.render("bet/wingo/trx.ejs", { trxdata: trxgetData });
        return res.render('../views/bet/wingo/trx.ejs', { trxdata: trxgetData });
    } catch (error) {
        console.error('Error fetching trx data:', error);
